...
const schema = z.object({
  ...
  DEPOSIT_MNEMONIC_ENC: z.string().optional(),
  DEPOSIT_MNEMONIC_ENCRYPTION_KEY: z.string().min(16).optional(),
...
export const env: Env = schema.parse({
  ...
  DEPOSIT_MNEMONIC_ENC: process.env.DEPOSIT_MNEMONIC_ENC,
  DEPOSIT_MNEMONIC_ENCRYPTION_KEY: process.env.DEPOSIT_MNEMONIC_ENCRYPTION_KEY,
