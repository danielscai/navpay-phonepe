...
class ModuleArtifactPlanningTest(unittest.TestCase):
    def test_profile_parser_accepts_build_modules_action(self) -> None:
        args = cache_manager.build_parser().parse_args(["profile", "full", "build-modules"])
    ...
    def test_resolve_module_spec_exposes_builder_metadata(self) -> None:
        ...
        expected = {
            "phonepe_sigbypass": {
                ...
                "outputs": {
                    "smali": cache_manager.REPO_ROOT / "src/signature_bypass/build/smali",
                    "pine_smali": cache_manager.REPO_ROOT / "src/signature_bypass/build/pine_smali",
                    "classes.dex": cache_manager.REPO_ROOT / "src/signature_bypass/build/classes.dex",
                    "libs/jni": cache_manager.REPO_ROOT / "src/signature_bypass/libs/jni",
                },
            },
            ...
            "phonepe_phonepehelper": {
                ...
                "outputs": {
                    "smali": cache_manager.REPO_ROOT / "src/phonepehelper/build/smali",
                },
            },
        }
