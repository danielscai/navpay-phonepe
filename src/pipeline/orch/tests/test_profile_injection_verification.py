...
class ProfileInjectionVerificationTest(unittest.TestCase):
    def test_verify_profile_injection_accepts_full_module_markers(self) -> None:
        manifest = {}
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            heartbeat_scheduler_smali = workspace / "smali_classes5/com/heartbeatbridge/HeartbeatScheduler.smali"
            heartbeat_contract_smali = workspace / "smali_classes5/com/heartbeatbridge/HeartbeatBridgeContract.smali"
            heartbeat_module_init_smali = workspace / "smali_classes5/com/heartbeatbridge/ModuleInit.smali"
            ...
            heartbeat_scheduler_smali.parent.mkdir(parents=True, exist_ok=True)
            heartbeat_contract_smali.parent.mkdir(parents=True, exist_ok=True)
            heartbeat_module_init_smali.parent.mkdir(parents=True, exist_ok=True)
            ...
            heartbeat_provider_smali.write_text(".class public Lcom/heartbeatbridge/HeartbeatBridgeProvider;\n", encoding="utf-8")
            heartbeat_sender_smali.write_text(".class public Lcom/heartbeatbridge/HeartbeatSender;\n", encoding="utf-8")
            heartbeat_scheduler_smali.write_text(".class public Lcom/heartbeatbridge/HeartbeatScheduler;\n", encoding="utf-8")
            heartbeat_contract_smali.write_text(".class public Lcom/heartbeatbridge/HeartbeatBridgeContract;\n", encoding="utf-8")
            heartbeat_module_init_smali.write_text(".class public Lcom/heartbeatbridge/ModuleInit;\n", encoding="utf-8")
