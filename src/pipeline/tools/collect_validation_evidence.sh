...
run_logged "gate_a_cli_contract" python3 -m unittest src/pipeline/orch/tests/test_cli_contract.py -v
run_logged "gate_a_all_tests" python3 -m unittest discover -s src/pipeline/orch/tests -p 'test_*.py' -v
